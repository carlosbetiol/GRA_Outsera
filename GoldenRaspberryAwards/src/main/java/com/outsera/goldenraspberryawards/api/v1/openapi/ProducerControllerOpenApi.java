...
@Tag(name = "Producers", description = "Producers management")
public interface ProducerControllerOpenApi {
    ...
    public ProducerResponseDTO createResource(ProducerRequestDTO dto);
    ...
    public ProducerResponseDTO updateResource(@Parameter(description = "Resource id") Long id,
                                      ProducerRequestDTO dto);
