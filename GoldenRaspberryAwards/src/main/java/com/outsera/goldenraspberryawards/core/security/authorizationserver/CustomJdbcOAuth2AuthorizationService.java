 ...
 * @see RowMapper
 */
@ImportRuntimeHints(CustomJdbcOAuth2AuthorizationService.JdbcOAuth2AuthorizationServiceRuntimeHintsRegistrar.class)
public class CustomJdbcOAuth2AuthorizationService implements OAuth2AuthorizationService {
	...
	private static final String TABLE_NAME = "\"awards_schema\".\"oauth2_authorization\"";
