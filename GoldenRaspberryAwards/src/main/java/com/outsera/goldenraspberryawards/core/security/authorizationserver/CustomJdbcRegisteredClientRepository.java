 ...
 * @see RowMapper
 */
@ImportRuntimeHints(CustomJdbcRegisteredClientRepository.JdbcRegisteredClientRepositoryRuntimeHintsRegistrar.class)
public class CustomJdbcRegisteredClientRepository implements RegisteredClientRepository {
	...
	private static final String TABLE_NAME = "\"awards_schema\".\"oauth2_registered_client\"";
